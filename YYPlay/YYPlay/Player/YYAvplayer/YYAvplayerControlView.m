...
@interface YYAvplayerControlView ()
/** 标题 */
...
@implementation YYAvplayerControlView
...
- (UIImageView *)topImageView
{
    if (!_topImageView) {
        ...
        _topImageView.image                  = YYAvplayerImage(@"YYAvplayer_top_shadow");
    }
...
- (UIImageView *)bottomImageView
{
    if (!_bottomImageView) {
        ...
        _bottomImageView.image                  = YYAvplayerImage(@"YYAvplayer_bottom_shadow");
    }
...
- (UIButton *)lockBtn
{
    if (!_lockBtn) {
        ...
        [_lockBtn setImage:YYAvplayerImage(@"YYAvplayer_unlock-nor") forState:UIControlStateNormal];
        [_lockBtn setImage:YYAvplayerImage(@"YYAvplayer_lock-nor") forState:UIControlStateSelected];
    }
    return _lockBtn;
}
...
- (UIButton *)startBtn
{
    if (!_startBtn) {
        ...
        [_startBtn setImage:YYAvplayerImage(@"YYAvplayer_play") forState:UIControlStateNormal];
        [_startBtn setImage:YYAvplayerImage(@"YYAvplayer_pause") forState:UIControlStateSelected];
    }
    return _startBtn;
}
...
- (ASValueTrackingSlider *)videoSlider
{
    if (!_videoSlider) {
        ...
        // 设置slider
        [_videoSlider setThumbImage:YYAvplayerImage(@"YYAvplayer_slider") forState:UIControlStateNormal];
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:YYAvplayerImage(@"YYAvplayer_shrinkscreen") forState:UIControlStateSelected];
    }
...
- (UILabel *)horizontalLabel
{
    if (!_horizontalLabel) {
        ...
        _horizontalLabel.backgroundColor = [UIColor colorWithPatternImage:YYAvplayerImage(@"YYAvplayer_management_mask")];
    }
...
- (UIButton *)repeatBtn
{
    if (!_repeatBtn) {
        ...
        [_repeatBtn setImage:YYAvplayerImage(@"YYAvplayer_repeat_video") forState:UIControlStateNormal];
    }
    return _repeatBtn;
}
...
- (UIButton *)downLoadBtn
{
    if (!_downLoadBtn) {
        ...
        [_downLoadBtn setImage:YYAvplayerImage(@"YYAvplayer_download") forState:UIControlStateNormal];
        [_downLoadBtn setImage:YYAvplayerImage(@"YYAvplayer_not_download") forState:UIControlStateDisabled];
    }
    return _downLoadBtn;
}
...
- (UIButton *)playeBtn
{
    if (!_playeBtn) {
        ...
        [_playeBtn setImage:YYAvplayerImage(@"YYAvplayer_play_btn") forState:UIControlStateNormal];
    }
    return _playeBtn;
}
