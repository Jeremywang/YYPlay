...
#import "YYValuePopUPview.h"

@implementation CALayer (YYAnimationAdditions)
...
NSString *const YYSliderFillColorAnim = @"fillColor";

@implementation YYValuePopUpview
...
- (void)setColor:(UIColor *)color
{
    ...
    [_colorAnimLayer removeAnimationForKey:YYSliderFillColorAnim];
}
...
{
    [[_attributedString mutableString] setString:text];
...
- (void)setAnimatedColors:(NSArray *)animatedColors withKeyTimes:(NSArray *)keyTimes
{
    ...
    CAKeyframeAnimation *colorAnim = [CAKeyframeAnimation animationWithKeyPath:YYSliderFillColorAnim];
    ...
    [_colorAnimLayer addAnimation:colorAnim forKey:YYSliderFillColorAnim];
}

- (void)setAnimationOffset:(CGFloat)animOffset returnColor:(void (^)(UIColor *))block
{
    if ([_colorAnimLayer animationForKey:YYSliderFillColorAnim]) {
...
- (void)animateBlock:(void (^)(CFTimeInterval))block
{
    _shouldAnimate = YES;
    _animDuration = 0.5;
