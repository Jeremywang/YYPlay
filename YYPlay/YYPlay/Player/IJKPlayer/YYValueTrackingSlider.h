...
@protocol YYValueTrackingSliderDelegate;
@protocol YYValueTrackingSliderDataSource;

@interface YYValueTrackingSlider : UISlider
...
@property (weak, nonatomic) id<YYValueTrackingSliderDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<YYValueTrackingSliderDelegate> delegate;
@end
...
@protocol YYValueTrackingSliderDataSource <NSObject>
- (NSString *)slider:(YYValueTrackingSlider *)slider stringForValue:(float)value;
@end
...
@protocol YYValueTrackingSliderDelegate <NSObject>
- (void)sliderWillDisplayPopUpView:(YYValueTrackingSlider *)slider;

@optional
- (void)sliderWillHidePopUpView:(YYValueTrackingSlider *)slider;
- (void)sliderDidHidePopUpView:(YYValueTrackingSlider *)slider;
@end
