...
@interface YYValueTrackingSlider()<YYValuePopUpViewDelegate>

@property (strong, nonatomic) YYValuePopUpview *popUpView;
@property (nonatomic) BOOL popUpViewAlwaysOn;  //default is NO

@end

@implementation YYValueTrackingSlider
{
...
- (void)setup
{
    ...
    self.popUpView = [[YYValuePopUpview alloc] initWithFrame:CGRectZero];
